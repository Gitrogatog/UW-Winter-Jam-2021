...
public class TDGun : MonoBehaviour, IWeapon
{
	...
	void Shoot() {
		...
		if (!isReloading && Time.time > nextShotTime && projectilesRemainingInMag > 0) {
			...
			if(shootImpulse != null){
				shootImpulse.m_DefaultVelocity = new Vector3((Random.Range(0,2)*2-1), Random.Range(0,2)*2-1, 0f);
				shootImpulse.GenerateImpulseWithForce(shakeIntensity);
			}
