...
public class EnemyHiderScript : MonoBehaviour
{
    [HideInInspector]
    ...
    private IEnumerator Hide(Transform Target)
    {
        ...
        while (true)
        {
            ...
            int hits = Physics.OverlapSphereNonAlloc(Agent.transform.position, LineOfSightChecker.checkCollider.radius, Colliders, HidableLayers);
